...
rho[k,l,u] #parameter is affected by the gate type k assigned to the flight and the arrival and departure taxiing times
...
N_w_tau[w,u] #Capacity limit of apron w at time u
...
#Deze klopt niet helemaal, gamma is oud/fout
TA[i,k,gamma_arrival[i]] #is the taxiing time from runway γ to gate type k for flight i
TA[i,k,gamma] #is the taxiing time from runway γ to gate type k
